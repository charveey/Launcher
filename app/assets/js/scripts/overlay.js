...
function populateServerListings(){
    ...
    for(const serv of servers){
        htmlString += `
        <div class="col s12">
            <div class="card white hoverable horizontal serverListing" servid="${serv.getID()}" ${serv.getID() === giaSel ? 'selected' : ''}>
                <div class="card-image">
                    <img src="${serv.getIcon()}">
                </div>
                <div class="card-content">
                    <div class="card-title">
                        Verzió ${serv.getMinecraftVersion()}
                    </div>
                    ${serv.getDescription()}
                </div>
            </div>
